...
async def rockpaper(ctx: discord.ApplicationContext, choice: str):
    ...
    msg = "Invalid choice. Try Rock, rock, Paper, paper, Scissors or scissors"
    author = ctx.author

    if bot_turn == "Rock" and choice.lower() == "Rock".lower():
        msg = f"Sofie: 🗿 | {author.name}: 🗿. It's a tie!"
    elif bot_turn == "Rock" and choice.lower() == "Paper".lower():
        msg = f"Sofie: 🗿 | {author.name}: 📄. You win!"
    elif bot_turn == "Rock" and choice.lower() == "Scissors".lower():
        msg = f"Sofie: 🗿 | {author.name}: ✂. You lose!"
    
    elif bot_turn == "Paper" and choice.lower() == "Rock".lower():
        msg = f"Sofie: 📄 | {author.name}: 🗿. You lose!"
    elif bot_turn == "Paper" and choice.lower == "Paper".lower():
        msg = f"Sofie: 📄 | {author.name}: 📄. It's a tie!"
    elif bot_turn == "Paper" and choice.lower() == "Scissors".lower():
        msg = f"Sofie: 📄 | {author.name}: ✂. You win!"
    
    elif bot_turn == "Scissors" and choice.lower() == "Rock".lower():
        msg = f"Sofie: ✂ | {author.name}: 🗿. You win!"
    elif bot_turn == "Scissors" and choice.lower() == "Paper".lower():
        msg = f"Sofie: ✂ | {author.name}: 📄. You lose!"
    elif bot_turn == "Scissors" and choice.lower() == "Scissors".lower():
        msg = f"Sofie: ✂ | {author.name}: ✂. It's a tie!"
